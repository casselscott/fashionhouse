...
function OrderScreen() {
  ...
  return (
    <Layout title={`Order ${orderId}`}>
      <h1 className="mb-4 text-xl text-black font-bold">{`Order ${orderId}`}</h1>
      {loading ? (
        <div>Loading...</div>
      ) : error ? (
        ...
        <div className="grid md:grid-cols-4 md:gap-5">
          <div className="overflow-x-auto md:col-span-3">
            ...
            <div className="card p-5">
              ...
              {isPaid ? (
                <div className="alert-success text-black font-bold">
                  Paid at {paidAt}
                </div>
              ) : (
            ...
            <div className="card overflow-x-auto p-5">
              ...
              <table className="min-w-full">
                <thead className="border-b">
                  <tr>
                    <th className="px-5 text-left text-black font-bold">
                      Item
                    </th>
                    <th className="    p-5 text-right text-black font-bold">
                      Quantity
                    </th>
                    <th className="  p-5 text-right text-black font-bold">
                      Price
